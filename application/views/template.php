    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">AKHDAN BLOG</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Akhdan B</div>
                    <div class="email">akhdan.malang@gmail.com</div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                    <a href="<?=base_url('index.php/Dashboard/v_profil')?>">
                    ...
                    <li class="active">
                    <a href="<?=base_url('index.php/Dashboard/v_form')?>">
                    ...
                    <li class="active">
                    <a href="<?=base_url('index.php/Dashboard/v_tables')?>">
                    <i class = "material-icons">view_list</i>
                    <span>Table</span>
                    </a>
                    
                    <li class="active">
                    <a href="<?=base_url('index.php/Dashboard/v_media')?>">
